...
<div class="container" id="about">
  ...
  <br><br>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-4">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link text-dark" href="#top">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark" href="#about">About Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark" href="createuser.php">Create User</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark" href="transfermoney.php">Transfer Money</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark" href="transactionhistory.php">Transaction History</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <span>Copyright ©️ 2021,All right reserved Dhiraj Patil</span>
  </div>
    </div>
  </footer>
</body>
